...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def computeActionFromValues(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        #o sa verific daca starea e o stare terminala
        
        #daca da, nu exista act posibile asa ca returnam None
        #obtinem toate actiunile posibile pt starea data
        #initializam un dictionar pt a stoca val Q pt fiecare actiune
#det actiunea cu cea ma =i mare valoare Q 
        if self.mdp.isTerminal(state):
            return None
        best_action = None
        max_value = float('-inf')
...
class PrioritizedSweepingValueIterationAgent(ValueIterationAgent):
    ...
    def runValueIteration(self):
        "*** YOUR CODE HERE ***"
        #initializeaza o coada de prioritate goala
       
        pq = util.PriorityQueue()
# obtine toate starile din modelul de decizie markov
        all_states = self.mdp.getStates()
  #calc predecesorii tututor starilor
        ...
        #pt fiecare stare non terminala, calc dif si actualizez coada
        ...
        #execut un nr de iteratii specificat..
...
#pt fiecare predecesor al starii actuale, actualizez dif si daca i necesar si coada de prioritate gen
